"""Vendored 'paginate' 0.5.7 (single-file flattening).

Copyright (c) 2007-2012 Christoph Haas <email@christoph-haas.de>
MIT license — see NOTICE in the repository root.

Upstream (github.com/Signum/paginate) is dormant since 2017; docsforge
bundles it so the blog plugin has no external dependency.
"""
