...
class MinifyPlugin(BasePlugin):
    ...
    config_scheme: Tuple = (
        ("minify_html", docsforge.config.config_options.Type(bool, default=False)),
        ("minify_js", docsforge.config.config_options.Type(bool, default=False)),
        ("minify_css", docsforge.config.config_options.Type(bool, default=False)),
        ("js_files", docsforge.config.config_options.Type((str, list), default=None)),
        ("css_files", docsforge.config.config_options.Type((str, list), default=None)),
        ("htmlmin_opts", docsforge.config.config_options.Type((str, dict), default=None)),
        ("cache_safe", docsforge.config.config_options.Type(bool, default=False)),
    )
