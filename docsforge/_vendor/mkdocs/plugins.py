...
from docsforge._vendor.mkdocs.config.base import Config, ConfigErrors, ConfigWarnings, LegacyConfig, PlainConfigSchema

if TYPE_CHECKING:
    from docsforge._vendor.mkdocs.config.defaults import MkDocsConfig
    from docsforge._vendor.mkdocs.livereload import LiveReloadServer
    from docsforge._vendor.mkdocs.structure.files import Files
    from docsforge._vendor.mkdocs.structure.nav import Navigation
    from docsforge._vendor.mkdocs.structure.pages import Page
    from docsforge._vendor.mkdocs.utils.templates import TemplateContext
...
def event_priority(priority: float) -> Callable[[T], T]:
    ...
    ```python
    try:
        from docsforge._vendor.mkdocs.plugins import event_priority
    except ImportError:
...
def get_plugin_logger(name: str) -> PrefixedLogger:
    ...
    Example:
        ```python
        from docsforge._vendor.mkdocs.plugins import get_plugin_logger
