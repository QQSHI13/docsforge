...
from docsforge._vendor.mkdocs.utils import normalize_url

if TYPE_CHECKING:
    from docsforge._vendor.mkdocs.config.config_options import ExtraScriptValue
    from docsforge._vendor.mkdocs.config.defaults import MkDocsConfig
    from docsforge._vendor.mkdocs.structure.files import File
