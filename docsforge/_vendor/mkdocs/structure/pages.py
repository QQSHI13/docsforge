...
from docsforge._vendor.mkdocs.structure import StructureItem
from docsforge._vendor.mkdocs.structure.toc import get_toc
from docsforge._vendor.mkdocs.utils import _removesuffix, get_build_date, get_markdown_title, meta, weak_property
from docsforge._vendor.mkdocs.utils.rendering import get_heading_text

if TYPE_CHECKING:
    from xml.etree import ElementTree as etree

    from docsforge._vendor.mkdocs.config.defaults import MkDocsConfig
    from docsforge._vendor.mkdocs.structure.files import File, Files
    from docsforge._vendor.mkdocs.structure.toc import TableOfContents
