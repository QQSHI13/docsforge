...
from docsforge._vendor.properdocs.config.base import ValidationError
...
try:
    ...
    from docsforge._vendor.properdocs.utils.babel_stub import Locale, UnknownLocaleError  # type: ignore
