...
from docsforge._vendor.properdocs.structure import StructureItem
from docsforge._vendor.properdocs.structure.toc import get_toc
from docsforge._vendor.properdocs.utils import get_build_date, get_markdown_title, meta, weak_property
from docsforge._vendor.properdocs.utils.rendering import get_heading_text

if TYPE_CHECKING:
    from xml.etree import ElementTree as etree

    from docsforge._vendor.properdocs.config.defaults import ProperDocsConfig
    from docsforge._vendor.properdocs.structure.files import File, Files
    from docsforge._vendor.properdocs.structure.toc import TableOfContents
