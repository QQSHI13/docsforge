...
from docsforge._vendor.properdocs.utils import cache
from docsforge._vendor.properdocs.utils import yaml as yaml_util
...
def get_deps(
    ...
    """
    Print PyPI package dependencies inferred from a docsforge.yml file based on a reverse mapping of known projects.
