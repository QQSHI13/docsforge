...
from docsforge._vendor.properdocs.utils import normalize_url

if TYPE_CHECKING:
    from docsforge._vendor.properdocs.config.config_options import ExtraScriptValue
    from docsforge._vendor.properdocs.config.defaults import ProperDocsConfig
    from docsforge._vendor.properdocs.structure.files import File
