...
from docsforge._vendor.properdocs.config import base
from docsforge._vendor.properdocs.config import config_options as c
from docsforge._vendor.properdocs.structure.pages import Page, _AbsoluteLinksValidationValue
from docsforge._vendor.properdocs.utils.yaml import get_yaml_loader, yaml_load
...
class ProperDocsConfig(base.Config):
    ...
    """The path to the docsforge.yml config file. Can't be populated from the config."""
