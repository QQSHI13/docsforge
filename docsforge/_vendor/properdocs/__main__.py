...
def _enable_warnings():
    ...
    if not sys.warnoptions:
        from docsforge._vendor.properdocs.commands import build
...
def serve_command(**kwargs):
    ...
    from docsforge._vendor.properdocs.commands import serve
...
def gh_deploy_command(
    ...
    from docsforge._vendor.properdocs.commands import build, gh_deploy
...
def get_deps_command(config_file, projects_file):
    ...
    from docsforge._vendor.properdocs.commands.get_deps import get_deps, get_projects_file
    from docsforge._vendor.properdocs.config.base import _open_config_file
...
def new_command(project_directory):
    ...
    from docsforge._vendor.properdocs.commands import new
